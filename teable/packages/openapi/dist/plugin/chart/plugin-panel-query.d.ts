...
import { z } from '../../zod';
export declare const GET_PLUGIN_PANEL_INSTALL_PLUGIN_QUERY = "/plugin/chart/{pluginInstallId}/plugin-panel/{positionId}/query";
export declare const getPluginPanelInstallPluginQueryRoSchema: z.ZodObject<{
    tableId: z.ZodString;
    cellFormat: z.ZodOptional<z.ZodNativeEnum<typeof CellFormat>>;
}, "strip", z.ZodTypeAny, {
    tableId: string;
...
export type IGetPluginPanelInstallPluginQueryRo = z.infer<typeof getPluginPanelInstallPluginQueryRoSchema>;
export declare const GetPluginPanelInstallPluginQueryRoute: RouteConfig;
export declare const getPluginPanelInstallPluginQuery: (pluginInstallId: string, positionId: string, query: IGetPluginPanelInstallPluginQueryRo) => Promise<import("axios").AxiosResponse<{
    rows: Record<string, unknown>[];
    columns: {
        name: string;
        type: import("../../base").BaseQueryColumnType;
        column: string;
        fieldSource?: {
            id: string;
            name: string;
