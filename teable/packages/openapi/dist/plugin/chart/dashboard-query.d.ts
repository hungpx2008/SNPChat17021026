...
import { z } from '../../zod';
export declare const GET_DASHBOARD_INSTALL_PLUGIN_QUERY = "/plugin/chart/{pluginInstallId}/dashboard/{positionId}/query";
export declare const getDashboardInstallPluginQueryRoSchema: z.ZodObject<{
    baseId: z.ZodString;
...
export type IGetDashboardInstallPluginQueryRo = z.infer<typeof getDashboardInstallPluginQueryRoSchema>;
export declare const GetDashboardInstallPluginQueryRoute: RouteConfig;
export declare const getDashboardInstallPluginQuery: (pluginInstallId: string, positionId: string, query: IGetDashboardInstallPluginQueryRo) => Promise<import("axios").AxiosResponse<{
