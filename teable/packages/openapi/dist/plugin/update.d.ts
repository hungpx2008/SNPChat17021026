...
export declare const UPDATE_PLUGIN = "/plugin/{id}";
export declare const updatePluginRoSchema: z.ZodObject<{
    name: z.ZodString;
...
export declare const updatePluginVoSchema: z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
    description: z.ZodOptional<z.ZodString>;
    detailDesc: z.ZodOptional<z.ZodString>;
...
export declare const updatePluginRoute: RouteConfig;
export declare const updatePlugin: (id: string, data: IUpdatePluginRo) => Promise<import("axios").AxiosResponse<{
    status: PluginStatus;
    name: string;
    id: string;
    createdTime: string;
