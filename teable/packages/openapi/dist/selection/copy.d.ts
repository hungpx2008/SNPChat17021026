...
export declare const COPY_URL = "/table/{tableId}/selection/copy";
export declare const copyVoSchema: z.ZodObject<{
    content: z.ZodString;
...
export declare const CopyRoute: RouteConfig;
export declare const copy: (tableId: string, copyRo: IRangesRo) => Promise<import("axios").AxiosResponse<{
    header: {
        id: string;
        name: string;
        dbFieldName: string;
