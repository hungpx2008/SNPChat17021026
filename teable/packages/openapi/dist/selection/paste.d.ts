...
import { z } from '../zod';
export declare const PASTE_URL = "/table/{tableId}/selection/paste";
export declare const pasteRoSchema: z.ZodObject<{
    ...
    type?: import("./range").RangeType | undefined;
...
export declare const pasteVoSchema: z.ZodObject<{
    ranges: z.ZodTuple<[z.ZodTuple<[z.ZodNumber, z.ZodNumber], null>, z.ZodTuple<[z.ZodNumber, z.ZodNumber], null>], null>;
}, "strip", z.ZodTypeAny, {
...
export declare const PasteRoute: RouteConfig;
export declare const paste: (tableId: string, pasteRo: IPasteRo) => Promise<import("axios").AxiosResponse<{
    ranges: [[number, number], [number, number]];
}, any>>;
