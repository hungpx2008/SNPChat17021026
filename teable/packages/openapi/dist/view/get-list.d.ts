...
export declare const GET_VIEW_LIST = "/table/{tableId}/view";
export declare const GetViewListRoute: RouteConfig;
export declare const getViewList: (tableId: string) => Promise<import("axios").AxiosResponse<{
    createdTime: string;
    createdBy: string;
    id: string;
    name: string;
