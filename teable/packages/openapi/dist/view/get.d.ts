...
export declare const GET_VIEW = "/table/{tableId}/view/{viewId}";
export declare const GetViewRoute: RouteConfig;
export declare const getView: (tableId: string, viewId: string) => Promise<import("axios").AxiosResponse<{
    createdTime: string;
    createdBy: string;
    id: string;
    name: string;
