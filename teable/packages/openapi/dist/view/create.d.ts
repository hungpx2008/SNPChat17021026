...
import type { IViewRo } from '@teable/core';
export declare const CREATE_VIEW = "/table/{tableId}/view";
export declare const CreateViewRoute: RouteConfig;
export declare const createView: (tableId: string, viewRo: IViewRo) => Promise<import("axios").AxiosResponse<{
    createdTime: string;
    createdBy: string;
    id: string;
    name: string;
