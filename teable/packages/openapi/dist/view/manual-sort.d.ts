...
import type { IManualSortRo } from '@teable/core';
export declare const VIEW_MANUAL_SORT = "/table/{tableId}/view/{viewId}/manual-sort";
export declare const ManualSortViewRoute: RouteConfig;
export declare const manualSortView: (tableId: string, viewId: string, sortRo: IManualSortRo) => Promise<import("axios").AxiosResponse<{
    createdTime: string;
    createdBy: string;
    id: string;
    name: string;
