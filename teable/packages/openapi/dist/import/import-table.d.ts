...
export declare const IMPORT_TABLE = "/import/{baseId}";
export declare const ImportTableFromFileRoute: RouteConfig;
export declare const importTableFromFile: (baseId: string, importRo: IImportOptionRo) => Promise<import("axios").AxiosResponse<{
    name: string;
    id: string;
    records: {
        id: string;
