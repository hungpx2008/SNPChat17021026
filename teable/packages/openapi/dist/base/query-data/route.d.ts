import { z } from '../../zod';
export declare const baseQueryColumnSchema: z.ZodObject<{
    name: z.ZodString;
    column: z.ZodString;
    type: z.ZodNativeEnum<typeof import("./types").BaseQueryColumnType>;
    fieldSource: z.ZodOptional<z.ZodObject<{
        id: z.ZodString;
        name: z.ZodString;
    ...
    name: string;
    type: import("./types").BaseQueryColumnType;
    column: string;
    fieldSource?: {
        id: string;
        name: string;
...
export declare const baseQuerySchemaVo: z.ZodObject<{
