...
import { z } from '../zod';
export declare const BASE_ERD = "/base/{baseId}/erd";
export declare const baseErdTableNodeSchema: z.ZodObject<{
    id: z.ZodString;
    name: z.ZodString;
    icon: z.ZodOptional<z.ZodString>;
    crossBaseId: z.ZodOptional<z.ZodString>;
    crossBaseName: z.ZodOptional<z.ZodString>;
    ...
    }, "name" | "type" | "id" | "isLookup" | "isConditionalLookup" | "isPrimary">, "strip", z.ZodTypeAny, {
        name: string;
        type: FieldType;
        id: string;
...
export declare const baseErdEdgeSchema: z.ZodObject<{
    source: z.ZodObject<{
        tableId: z.ZodString;
    ...
    relationship: z.ZodOptional<z.ZodNativeEnum<typeof Relationship>>;
    isOneWay: z.ZodOptional<z.ZodBoolean>;
    type: z.ZodUnion<[z.ZodNativeEnum<typeof FieldType>, z.ZodLiteral<"lookup">]>;
}, "strip", z.ZodTypeAny, {
    type: "lookup" | FieldType;
    source: {
        tableId: string;
        fieldId: string;
        tableName: string;
...
export declare const baseErdVoSchema: z.ZodObject<{
    baseId: z.ZodString;
...
export declare const getBaseErdRoute: RouteConfig;
export declare const getBaseErd: (baseId: string) => Promise<import("axios").AxiosResponse<{
    baseId: string;
    nodes: z.objectOutputType<{
        id: z.ZodString;
        name: z.ZodString;
