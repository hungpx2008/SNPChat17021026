...
exports.getFormulaPrompt = void 0;
const func_define_1 = require("./func-define");
const getFormulaPrompt = (prompt, fields, includeReturnTypes) => {
    const context = fields.map((field) => field.name).join('\n');
    // Convert function definitions to a readable format
    const functionDocs = func_define_1.funcDefine
        .map(([_name, schema]) => {
...
exports.getFormulaPrompt = getFormulaPrompt;
