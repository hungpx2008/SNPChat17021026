...
import type { IRangesRo } from '../selection';
export declare const SHARE_VIEW_COPY = "/share/{shareId}/view/copy";
export declare const ShareViewCopyRoute: RouteConfig;
export declare const shareViewCopy: (shareId: string, copyRo: IRangesRo) => Promise<import("axios").AxiosResponse<{
    header: {
        id: string;
        name: string;
        dbFieldName: string;
