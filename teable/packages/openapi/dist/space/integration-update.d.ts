...
import { z } from '../zod';
export declare const UPDATE_INTEGRATION = "/space/{spaceId}/integration/{integrationId}";
export declare const updateIntegrationRoSchema: z.ZodObject<{
...
export declare const UpdateIntegrationRoute: RouteConfig;
export declare const updateIntegration: (spaceId: string, integrationId: string, updateIntegrationRo: IUpdateIntegrationRo) => Promise<import("axios").AxiosResponse<any, any>>;
