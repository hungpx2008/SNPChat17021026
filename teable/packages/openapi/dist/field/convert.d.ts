...
export declare const CONVERT_FIELD = "/table/{tableId}/field/{fieldId}/convert";
export declare const ConvertFieldRoute: RouteConfig;
export declare const convertField: (tableId: string, fieldId: string, fieldRo: IConvertFieldRo) => Promise<import("axios").AxiosResponse<{
    id: string;
    name: string;
    dbFieldName: string;
