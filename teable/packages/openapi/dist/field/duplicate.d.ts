...
import { z } from '../zod';
export declare const DUPLICATE_FIELD = "/table/{tableId}/field/{fieldId}/duplicate";
export declare const duplicateFieldRoSchema: z.ZodObject<{
    name: z.ZodString;
...
export declare const DuplicateFieldRoute: RouteConfig;
export declare const duplicateField: (tableId: string, fieldId: string, duplicateFieldRo: IDuplicateFieldRo) => Promise<import("axios").AxiosResponse<{
    id: string;
    name: string;
    dbFieldName: string;
