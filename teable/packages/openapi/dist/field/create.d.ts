...
export declare const CREATE_FIELD = "/table/{tableId}/field";
export declare const CreateFieldRoute: RouteConfig;
export declare const createField: (tableId: string, fieldRo: IFieldRo) => Promise<import("axios").AxiosResponse<{
    id: string;
    name: string;
    dbFieldName: string;
