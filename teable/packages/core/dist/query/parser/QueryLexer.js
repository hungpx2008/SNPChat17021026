...
class QueryLexer extends Lexer_1.Lexer {
    static COMMA = 1;
    static OPEN_PAREN = 2;
    ...
    static VOCABULARY = new VocabularyImpl_1.VocabularyImpl(QueryLexer._LITERAL_NAMES, QueryLexer._SYMBOLIC_NAMES, []);
    // @Override
    // @NotNull
    get vocabulary() {
    ...
    constructor(input) {
        super(input);
        this._interp = new LexerATNSimulator_1.LexerATNSimulator(QueryLexer._ATN, this);
    }
    // @Override
    get grammarFileName() {
    ...
    static _serializedATN = '\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02$\u017D\b\x01' +
    ...
    static get _ATN() {
        if (!QueryLexer.__ATN) {
            QueryLexer.__ATN = new ATNDeserializer_1.ATNDeserializer().deserialize(Utils.toCharArray(QueryLexer._serializedATN));
        }
