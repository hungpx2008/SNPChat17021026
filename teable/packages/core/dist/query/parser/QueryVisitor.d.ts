...
import type { PredicateExprLikeContext, PredicateExprInContext, PredicateExprHasContext, PredicateExprEqArrayContext, PrimaryExprPredicateContext, PrimaryExprIsContext, PrimaryExprCompareContext, QueryExprContext, BinaryExprContext, ParenQueryExprContext, StartContext, ExprContext, QueryStatementContext, PredicateContext, FieldIdentifierContext, CompOpContext, IsOpContext, LikeOpContext, InOpContext, ValueContext, ValueListContext, LiteralContext, StringLiteralContext, NumberLiteralContext, BooleanLiteralContext, NullLiteralContext } from './Query';
/**
