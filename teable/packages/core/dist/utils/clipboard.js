...
exports.stringifyClipboardText = exports.parseClipboardText = void 0;
const delimiter = '\t';
const newline = '\n';
const windowsNewline = '\r\n';
// eslint-disable-next-line sonarjs/cognitive-complexity
const parseClipboardText = (content) => {
...
exports.parseClipboardText = parseClipboardText;
const stringifyClipboardText = (content) => {
    return content
        .map((row) => row
        .map((cell) => cell.includes(delimiter) || cell.includes(newline)
        ? `"${cell.replace(/"/g, '""')}"`
        : cell)
        .join(delimiter))
        .join(newline);
};
exports.stringifyClipboardText = stringifyClipboardText;
