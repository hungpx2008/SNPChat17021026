  ...
  implements OnModuleInit
{
  ...
  private readonly defaultTxTimeout = PrismaService.parseOrDefault(
    process.env.PRISMA_TRANSACTION_TIMEOUT,
    process.env.NODE_ENV === 'production' ? 5000 : 20000
  );
  private readonly defaultTxMaxWait = PrismaService.parseOrDefault(
  ...
  private static parseOrDefault(value: string | undefined, fallback: number): number {
