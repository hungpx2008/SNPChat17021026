...
const CarouselPrevious = React.forwardRef(({ className, variant = 'outline', size = 'icon', onClick, ...props }, ref) => {
    ...
    return (_jsxs(Button, { ref: ref, variant: variant, size: size, className: cn('absolute h-8 w-8 rounded-full', orientation === 'horizontal'
            ...
            : '-top-12 left-1/2 -translate-x-1/2 rotate-90', className), disabled: !canScrollPrev, onClick: onClickInner, ...props, children: [_jsx(ArrowLeftIcon, { className: "h-4 w-4" }), _jsx("span", { className: "sr-only", children: "Previous slide" })] }));
});
CarouselPrevious.displayName = 'CarouselPrevious';
const CarouselNext = React.forwardRef(({ className, variant = 'outline', size = 'icon', onClick, ...props }, ref) => {
    ...
    return (_jsxs(Button, { ref: ref, variant: variant, size: size, className: cn('absolute h-8 w-8 rounded-full', orientation === 'horizontal'
            ...
            : '-bottom-12 left-1/2 -translate-x-1/2 rotate-90', className), disabled: !canScrollNext, onClick: onClickInner, ...props, children: [_jsx(ArrowRightIcon, { className: "h-4 w-4" }), _jsx("span", { className: "sr-only", children: "Next slide" })] }));
});
