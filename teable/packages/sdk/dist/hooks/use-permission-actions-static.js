...
const ACTION_PREFIX_DISPLAY_ORDER = [
    ActionPrefix.Record,
    ActionPrefix.Field,
    ActionPrefix.Table,
    ActionPrefix.View,
...
export const usePermissionActionsStatic = () => {
    ...
    return useMemo(() => {
        const actionStaticMap = Object.keys(actionsI18nMap).reduce((acc, key) => {
            const action = key;
            acc[action] = {
        ...
        const actionPrefixStaticMap = Object.values(ActionPrefix).reduce((acc, prefix) => {
            acc[prefix] = {
