...
export declare const useFieldOperations: () => {
    createField: import("@tanstack/react-query").UseMutateAsyncFunction<{
        id: string;
        name: string;
        dbFieldName: string;
    ...
    convertField: import("@tanstack/react-query").UseMutateAsyncFunction<{
        id: string;
        name: string;
        dbFieldName: string;
        type: import("@teable/core").FieldType;
    ...
    planFieldCreate: import("@tanstack/react-query").UseMutateAsyncFunction<{
        estimateTime: number;
        ...
        graph?: {
            nodes: import("zod").objectOutputType<{
                ...
                comboId: import("zod").ZodOptional<import("zod").ZodString>;
            }, import("zod").ZodTypeAny, "passthrough">[];
            edges: import("zod").objectOutputType<{
                source: import("zod").ZodString;
                target: import("zod").ZodString;
                label: import("zod").ZodOptional<import("zod").ZodString>;
            }, import("zod").ZodTypeAny, "passthrough">[];
            combos: import("zod").objectOutputType<{
                id: import("zod").ZodString;
    ...
    planFieldConvert: import("@tanstack/react-query").UseMutateAsyncFunction<{
    ...
    deleteField: import("@tanstack/react-query").UseMutateAsyncFunction<null, unknown, {
        tableId: string;
        fieldId: string;
    }, unknown>;
    autoFillField: import("@tanstack/react-query").UseMutateAsyncFunction<{
