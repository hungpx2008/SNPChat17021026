...
import { TableCore } from '@teable/core';
import type { IUpdateOrderRo, IRecordInsertOrderRo, ITableVo } from '@teable/openapi';
import type { Doc } from 'sharedb/lib/client';
export declare class Table extends TableCore {
    static getAggregations: (tableId: string, query?: {
    ...
    static getRowCount: (tableId: string, query?: {
        filter?: import("@teable/core").IFilterSet | null | undefined;
        viewId?: string | undefined;
        ignoreViewQuery?: boolean | undefined;
        filterByTql?: string | undefined;
    ...
    baseId: string;
    permission?: {
        [key in TableAction]: boolean;
    };
    getViews(): Promise<import("axios").AxiosResponse<{
        createdTime: string;
        createdBy: string;
        id: string;
        name: string;
    ...
    updateName(name: string): Promise<import("axios").AxiosResponse<void, any>>;
    updateDbTableName(dbTableName: string): Promise<import("axios").AxiosResponse<void, any>>;
    updateDescription(description: string | null): Promise<import("axios").AxiosResponse<void, any>>;
    updateIcon(icon: string): Promise<import("axios").AxiosResponse<void, any>>;
    updateOrder(orderRo: IUpdateOrderRo): Promise<import("axios").AxiosResponse<void, any>>;
    createView(viewRo: IViewRo): Promise<import("axios").AxiosResponse<{
        createdTime: string;
        createdBy: string;
        id: string;
        name: string;
    ...
    deleteView(viewId: string): Promise<import("axios").AxiosResponse<null, any>>;
    createRecord(recordFields: IRecord['fields'], recordOrder?: IRecordInsertOrderRo): Promise<import("axios").AxiosResponse<{
        records: {
            id: string;
    ...
    createField(fieldRo: IFieldRo): Promise<import("axios").AxiosResponse<{
        id: string;
        name: string;
        dbFieldName: string;
    ...
    updateField(fieldId: string, fieldRo: IUpdateFieldRo): Promise<import("axios").AxiosResponse<any, any>>;
    convertField(fieldId: string, fieldRo: IFieldRo): Promise<import("axios").AxiosResponse<{
        id: string;
        name: string;
        dbFieldName: string;
        type: import("@teable/core").FieldType;
    ...
    deleteField(fieldId: string): Promise<import("axios").AxiosResponse<null, any>>;
}
