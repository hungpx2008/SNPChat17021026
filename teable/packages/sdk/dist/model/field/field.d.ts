...
export declare abstract class Field extends FieldCore {
    tableId: string;
    protected doc: Doc<IFieldVo>;
    get canReadFieldRecord(): boolean;
    get canCreateFieldRecord(): boolean;
    create(fieldRo: IFieldRo): Promise<import("axios").AxiosResponse<{
        id: string;
        name: string;
        dbFieldName: string;
    ...
    update(updateFieldRo: IUpdateFieldRo): Promise<import("axios").AxiosResponse<any, any>>;
    convert(fieldRo: IFieldRo): Promise<import("axios").AxiosResponse<{
        id: string;
        name: string;
        dbFieldName: string;
        type: import("@teable/core").FieldType;
    ...
    delete(): Promise<import("axios").AxiosResponse<null, any>>;
}
