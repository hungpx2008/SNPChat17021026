...
const EditorContainer = React.forwardRef(({ className, disabled, focused, focusRing, readOnly, size, variant, ...props }, ref) => {
    return (_jsx("div", { ref: ref, className: "relative w-1/2", children: _jsx(PlateContent, { className: cn(editorVariants({
                disabled,
                focused,
                focusRing,
                size,
