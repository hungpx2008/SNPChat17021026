export const createGroupIndexCollections = (data) => {
    let cumulativeCount = 0;
    const groupIndexCollections = [];
...
export const binarySearchIndexPoint = (indexPoints, targetIndex) => {
    let low = 0;
...
export const getInfoByGroupIndexCollections = (groupIndexCollections, targetIndex) => {
