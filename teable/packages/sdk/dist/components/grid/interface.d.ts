...
export declare enum SelectionRegionType {
    Rows = "Rows",
    Columns = "Columns",
    Cells = "Cells",
    None = "None"
...
export declare enum DragRegionType {
    Rows = "Rows",
    Columns = "Columns",
    None = "None"
}
...
export declare enum RowControlType {
    Drag = "Drag",
    Expand = "Expand",
    Checkbox = "Checkbox"
}
...
export declare enum DraggableType {
    All = "all",
    None = "none",
    Column = "column",
    Row = "row"
}
export declare enum GridCustomIcon {
    Description = "description"
}
export declare enum SelectableType {
    All = "all",
    None = "none",
    Column = "column",
    Row = "row",
...
export declare enum LinearRowType {
    Group = 0,
    Row = 1,
    Append = 2
}
