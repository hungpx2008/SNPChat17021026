...
export declare enum NumberDisplayType {
    Ring = "ring",
    Bar = "bar"
}
...
export type IInnerCell = ITextCell | ILinkCell | INumberCell | ISelectCell | IImageCell | IRatingCell | IBooleanCell | IChartCell | IUserCell | IButtonCell;
...
export declare enum CellRegionType {
    Blank = "blank",
    Update = "update",
    Preview = "preview",
...
export interface ICellRegionWithData {
    type: CellRegionType.Update | CellRegionType.ToggleEditing | CellRegionType.Preview | CellRegionType.Blank | CellRegionType.Hover;
    data: unknown;
}
