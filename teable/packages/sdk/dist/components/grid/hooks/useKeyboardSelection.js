...
export const useKeyboardSelection = (props) => {
    const { isEditing, activeCell, coordInstance, selection, scrollToItem, setEditing, setActiveCell, setSelection, onUndo, onRedo, onDelete, onRowExpand, editorRef, scrollBy, } = props;
    ...
    useHotkeys(['delete', 'backspace', 'f2'], () => {
