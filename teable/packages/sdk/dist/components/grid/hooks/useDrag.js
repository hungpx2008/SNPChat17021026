...
export const getDropTargetIndex = (coordInstance, mouseState, scrollState, dragType) => {
...
export const useDrag = (coordInstance, scrollState, selection, draggable) => {
    ...
    const onDragStart = (mouseState, onEnd) => {
        ...
        if (type === RegionType.RowHeaderDragHandler && draggable !== DraggableType.Column) {
            ...
            const ranges = isRowSelection && selection.includes([hoverRowIndex, hoverRowIndex])
                ? selectionRanges
        ...
        if (type === RegionType.ColumnHeader && draggable !== DraggableType.Row) {
            ...
            const ranges = isColumnSelection && selection.includes([hoverColumnIndex, hoverColumnIndex])
                ? selectionRanges
