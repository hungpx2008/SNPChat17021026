...
export const getVerticalRangeInfo = (coordInstance, scrollTop) => {
...
export const getHorizontalRangeInfo = (coordInstance, scrollLeft) => {
...
export const useVisibleRegion = (coordInstance, scrollState, forceRenderFlag) => {
