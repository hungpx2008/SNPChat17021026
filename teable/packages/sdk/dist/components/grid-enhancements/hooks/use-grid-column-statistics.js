...
export function useGridColumnStatistics(columns) {
    ...
    const getColumnStatistics = useCallback((source) => {
        if (source == null)
            return {};
    ...
    useEffect(() => {
        if (remoteStatistics == null || viewId == null)
            return;
        const partialColumnStatistics = getColumnStatistics(remoteStatistics);
        if (partialColumnStatistics == null)
            return;
