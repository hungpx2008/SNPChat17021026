...
Intel system is disabled. To activate:
  ...
  node /Volumes/orical/ChatSNP/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node /Volumes/orical/ChatSNP/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node /Volumes/orical/ChatSNP/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node /Volumes/orical/ChatSNP/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: /Volumes/orical/ChatSNP/.claude/get-shit-done/bin/gsd-tools.cjs
